...
const avalancheBaseTokens: Tokens = {
  usdc: { symbol: 'USDC', address: '0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E' },
  usdt: { symbol: 'USDT', address: '0xc7198437980c041c805A1EDcbA50c1Ce5db95118' },
  dai: { symbol: 'DAI', address: '0xd586E7F844cEa2F87f50152665BCbc2C279D8d70' },
};

const avalancheQuoteTokens: Tokens = {
  wavax:          { symbol: 'WAVAX', address: '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7' },
  // wbtc:       { symbol: 'WBTC.e', address: '0x50b7545627a5162F82A992c33b87aDc75187B218' },
  // link:       { symbol: 'LINK.e', address: '0x5947BB275c521040051D82396192181b413227A3' },
  pangolinToken:  { symbol: 'PNG', address: '0x60781C2586D68229fde47564546784ab3fACA982' },
  joeToken:       { symbol: 'JOE', address: '0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd' },
  yakToken:       { symbol: 'YAK', address: '0x59414b3089ce2AF0010e7523Dea7E2b35d776ec7' },
  eggToken:       { symbol: 'EGG', address: '0x06534dbD3e383b553D15d260387Af5ffa6568783' },
  grapeToken:     { symbol: 'GRAPE', address: '0x17757dcE604899699b79462a63dAd925B82FE221' },
};
